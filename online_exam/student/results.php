                ...
                <?php else: ?>
                    <tr>
                        <td colspan="6" style="text-align:center; padding: 60px 0;">
                            <i class="fa-solid fa-folder-open" style="font-size:40px;color:#e2e8f0;margin-bottom:15px;"></i>
                            <p style="color: var(--text-muted);">No results found. Start an exam to see your performance here.</p>
                        </td>
                    </tr>
                <?php endif; ?>
                </tbody>
